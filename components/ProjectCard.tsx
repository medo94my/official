        ...
        <div className="flex gap-3">
          {githubUrl && (
            <motion.a
              ...
              className="flex-1 px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg text-center transition-colors flex items-center justify-center gap-2"
            >
          ...
          {liveUrl && (
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 px-4 py-2 bg-primary hover:bg-yellow-500 text-gray-900 font-semibold rounded-lg text-center transition-colors flex items-center justify-center gap-2"
            >
