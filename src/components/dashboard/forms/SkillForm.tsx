...
const SkillForm: FC<SkillFormProps> = ({ initialData, onSubmit, onCancel }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-4">
        <label htmlFor="level" className="block text-sm font-medium text-gray-700">Level (1-100)</label>
        <input
          type="number"
          id="level"
          name="level"
